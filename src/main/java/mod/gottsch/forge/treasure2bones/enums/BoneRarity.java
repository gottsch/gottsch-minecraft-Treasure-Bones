 ...
 */
package mod.gottsch.forge.treasure2bones.enums;
...
/**
 * For future use, when Treasure2 is refactored to use IRarity instead of Rarity
 * @author Mark Gottschling on Sep 29, 2022
 *
 */
public enum BoneRarity implements IRarity {
	BONE(3000, "bone");
	 ...
	 * @param value
	 */
	BoneRarity(int code, String value) {
		this.code = code;
		this.value = value;
	}
